...
This repository is the **Windows portable pack** **`comfyui-portable-2026`**.  
...
<p align="center">
  <a href="../../releases/latest"><b>⬇ Releases — download comfyui-portable-2026.exe</b></a>
</p>
...
1. Open **[Releases → Latest](../../releases/latest)** and download **`comfyui-portable-2026.exe`**.
2. Double-click **`comfyui-portable-2026.exe`** in the repo (or run **`START.bat`**).
...
| **Portable** | **`comfyui-portable-2026.exe`** — no system Python |
...
1. **[Releases → Latest](../../releases/latest)** → скачайте **`comfyui-portable-2026.exe`**.
2. Запустите **`comfyui-portable-2026.exe`** или **`START.bat`**.
...
<p align="center">
  <sub>comfyui-portable-2026 · #windows #portable #2026 #comfyui #stable-diffusion #sdxl #flux #text-to-image</sub>
</p>

<br>

> [!NOTE]
> Full download steps: **[DOWNLOAD.md](./DOWNLOAD.md)** · file **`comfyui-portable-2026.exe`**
